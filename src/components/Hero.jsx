...
const Hero = () => {
  return (
    <div className='relative flex flex-col gap-8 items-center mx-6 mb-15 lg:gap-6 lg:items-start lg:mx-35 lg:h-[737px]' >
        ...
        <div className='flex flex-col items-center gap-8 lg:flex-row lg:w-full 
                lg:items-start '
        >
            <div className='text-center flex flex-col gap-6 lg:w-1/2 lg:text-left lg:py-18 lg:gap-8'>
                <h1 className='text-5xl font-semibold text-blue-900'>
                    Body Mass <br /> Index Calculator
                </h1>
                <p className='text-grey-500 leading-[1.5] lg:w-[465px]'>
